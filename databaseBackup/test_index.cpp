...
list<ll> addr_l;
REQUIRE(index[0]
->query(0, "test", addr_l) == 0);
//����������
REQUIRE(contain(1, addr_l)
== true);
//��ַΨһ
REQUIRE(isSame(addr_l)
== false);
}
SECTION("���Զ�ȡ"){
Index *index[2];
...
REQUIRE(index
->
query(j, data[i][j], addr_l
) == 0);
REQUIRE(contain(i, addr_l)
== true);
}
}
